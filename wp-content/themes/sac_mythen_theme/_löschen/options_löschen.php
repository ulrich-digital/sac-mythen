<?php
    ...
    $themename = "ulrich.digital Blank Theme";
    $shortname = "ud_bt";
	
	/* functions to andale the options array  */
	
	function ud_bt_get_formatted_page_array() { 
	...
	function ud_bt_get_category_array() { 
	...
	function create_section_for_radio($value) { 
		...
		foreach ($value['options'] as $option_value => $option_text) {
			...
			echo '<div class="ud_bt-radio"><input type="radio" name="'.$value['id'].'" value="'.
	...
	function create_section_for_multi_select($value) { 
		create_opening_tag($value);
		echo '<ul class="ud_bt-checklist" id="'.$value['id'].'" >'."\n";
	...
	$options = array( 
		...
		array("name" => "Pages to show in Navigation Bar",
				...
				"type" => "multi-select",
				"options" => ud_bt_get_formatted_page_array($shortname."_nav_pages"),
				"parent" => "nav-setup",
				"std" => "none"
		),
		...
		array("name" => "category posts to show on the front page",
				...
				"type" => "select",
				"options" => ud_bt_get_category_array($shortname."_nav_pages"),
				"parent" => "nav-setup",
				"std" => ud_bt_get_category_array($shortname."_nav_pages")
		),
